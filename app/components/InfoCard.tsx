...
const InfoCard = ({ data }) => {
    return (
        <Card className="w-1/4 rounded-none grid grid-rows-8 gap-2">
            ...
            <CardFooter className="row-span-1">
                <Link className="text-2xl pb-2 text-blue-600 hover:text-blue-900 hover:border-b-2 border-blue-900" href={""}>
                    <p>
